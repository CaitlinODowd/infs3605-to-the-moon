...
public class QuizAnswer {
    ...
    public ArrayList<QuizAnswer> getAnswers () {
        ...
        answers.add(new QuizAnswer(0, "Yes", "Correct! AusGov will never ask you to give personal details over email or SMS. There's also no email personalisation and fonts are different sizes.", "Incorrect, remember that AusGov will never ask you to give personal details over email or SMS. There's also no email personalisation and fonts are different sizes.", R.drawable.a_1));
        ...
        answers.add(new QuizAnswer(4, "Yes", "Correct", "Wrong", R.drawable.a_1 ));
